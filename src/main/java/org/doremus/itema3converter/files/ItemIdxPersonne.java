...
public class ItemIdxPersonne extends ItemIdxFile {
    ...
    public static List<ItemIdxFile> byItem(String itemId) {
        ...
        for (File f : RecordConverter.getFilesStartingWith("ITEM_IDX_PERSONNE", itemId))
            list.add(ItemIdxPersonne.fromFile(f));
        return list;
    }
